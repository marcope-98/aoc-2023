...
static std::size_t isqrt(std::size_t x)
{
  std::size_t m, y, b;
...
static std::size_t test(const std::size_t &t, const std::size_t &tp) { return tp * (t - tp); }

static aoc::Range *solve(const std::size_t &a, const std::size_t &b, const std::size_t &c)
{
...
static std::size_t get_solutions(const std::size_t &t, const std::size_t &record)
{
...
static std::vector<std::size_t> get_input(const std::string &input)
{
...
static std::size_t get_concatenated_input(const std::string &input)
{
  std::string  out;
  aoc::vstring temp = aoc::parse::split_by_delimiters(input, " ");
  for (std::size_t i = 1; i < temp.size(); ++i)
